...
@section('content')
<form method="POST" action="{{route('register')}}" style="border-top-width: 26px;" class=" rounded-md bg-white  border-cyan-600 shadow-md border-1 p-12 flex flex-col ">
    @csrf
    ...
    <button class="p-1 rounded-md bg-cyan-700 hover:bg-cyan-500 text-white">Register</button>
      <a class="text-gray-500 pt-2" href="{{url('login')}}">Already have an account? <u class="text-cyan-600">Login</u></a>
