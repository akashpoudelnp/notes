...
@section('content')
    <div>
        <form action="{{ route('login') }}" method="post" style="border-top-width: 26px;"
            ...
            @csrf
            <input type="email" class="my-1 rounded-md border-teal-600" name="email" type="text"
            ...
            <input type="password" class="my-1 rounded-md border-teal-600" name="password" type="text"
