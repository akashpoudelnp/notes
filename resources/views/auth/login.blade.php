...
@section('content')
<div >
    <form action="{{route('login')}}" method="post" style="border-top-width: 26px;" class=" rounded-md bg-white  border-teal-600 shadow-md border-1 p-12 flex flex-col ">
    ...
    <button class="p-1 rounded-md bg-teal-700 hover:bg-teal-500 text-white">Login</button>
      <a class="text-gray-500 pt-2" href="{{url('register')}}">Dont have an account? <u class="text-teal-600">Register</u></a>
    </form>
